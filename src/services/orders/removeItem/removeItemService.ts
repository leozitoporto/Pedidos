...
export const RemoveItem = (indexOrder: number, command_row_prod_id: number): void => {
    ...
    orders[indexOrder]['order_items'].forEach((element: any, key: number) => {
        if (element.product_id === command_row_prod_id) {
           delete orders[indexOrder]['order_items'][key]
            
           // Atualiza qtyItems
           qtyItems.forEach((element : any, key: number) => {
            if(element.product_id === command_row_prod_id){
                delete qtyItems[key]
            }
           })
    ...
    orders[indexOrder]['order_items'].forEach((element: any) => {
    ...
    console.log("============================")
    console.log("FINAL DO removeItem")
    console.log("============================")
}